...
//  JamAlpha2
//
//  Created by Song Liao on 01/04/16.
...
class UnLoginSettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, MFMailComposeViewControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("present unlogin setting vc")
        setUpNavigationBar()
    }
