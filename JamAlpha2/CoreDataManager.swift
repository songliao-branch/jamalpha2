...
class CoreDataManager: NSObject {
    ...
    class func initializeUser(id: Int, email: String, authToken: String, nickname: String? = nil, avatarUrl: String? = nil, thumbnailUrl: String? = nil, profileImage: NSData?, thumbnail: NSData?) {
